...
plot(T3,X3(:,1), 'b')
plot(T4,X4(:,1), 'g')
title('Displacement: Heave, 2014 over speed bump')
xlabel('time (sec)')
...
plot(T3,V3(:,1), 'b')
plot(T4,V4(:,1), 'g')
title('Velocity: Heave, 2014 over speed bump')
xlabel('time (sec)')
...
plot(T3,A3(:,1), 'b')
plot(T4,A4(:,1), 'g')
title('Acceleration: Heave, 2014 over speed bump')
xlabel('time (sec)')
...
title('Rotation: Pitch, 2014 over speed bump')
xlabel('time (sec)')
...
title('Angular Velocity: Pitch, 2014 over speed bump')
xlabel('time (sec)')
...
title('Angular Acceleration: Pitch, 2014 over speed bump')
xlabel('time (sec)')
...
plot(T2,(X2(:,2)), 'r')
plot(T4,(X4(:,3)), 'g')
title('Displacement: Front Axle Motion, 2014 over speed bump')
xlabel('time (sec)')
ylabel('Displacement (ft)')
...
plot(T2,(V2(:,2)), 'r')
plot(T4,(V4(:,3)), 'g')
title('Velocity: Front Axle Motion, 2014 over speed bump')
xlabel('time (sec)')
ylabel('Velocity (ft/sec)')
legend('1/4 Car 2 DOF', '1/2 Car 4 DOF', 'Location', 'bestoutside')
hold off
...
plot(T2,(A2(:,2)), 'r')
plot(T4,(A4(:,3)), 'g')
title('Acceleration: Front Axle Motion, 2014 over speed bump')
xlabel('time (sec)')
...
hold on 
plot(T4,(X4(:,4)), 'g')
title('Displacement: Rear Axle Motion, 2014 over speed bump')
xlabel('time (sec)')
ylabel('Displacement (ft)')
...
hold on
plot(T4,(V4(:,4)), 'g')
title('Velocity: Rear Axle Motion, 2014 over speed bump')
xlabel('time (sec)')
ylabel('Velocity (ft/sec)')
legend('1/2 Car 4 DOF', 'Location', 'bestoutside')
hold off
...
hold on
plot(T4,(A4(:,4)), 'g')
title('Acceleration: Rear Axle Motion, 2014 over speed bump')
xlabel('time (sec)')
ylabel('Acceleration (ft/sec^2)')
legend('1/2 Car 4 DOF', 'Location', 'bestoutside')
hold off
