...
value103 ='quarter_car_2_DOF';          
value104 =@trajectory;
value105 = 0;         % seconds
value106 = 1.5;       % seconds
value107 = 5;         % miles per hour
value108 = 5;         % miles per hour
value109 = 2500;           
value110 =@(wheelbase,X_enter,X,V)speed_bump(wheelbase,X_enter,X,V);           
value111 = 1;         % feet
value112 =@(wheelbase,X_enter,X,V)speed_bump(wheelbase,X_enter,X,V);   
value113 = 1;         % feet
