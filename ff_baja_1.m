...
value103 ='quarter_car_1_DOF';  %%%%TYLER CHANGE THIS FOR EACH         
value104 =@trajectory;
value105 = 0;         % seconds
value106 = 2;       % seconds
value107 = 30;         % miles per hour
value108 = 20;         % miles per hour
value109 = 5000;           
value110 =@(wheelbase,X_enter,X,V)agony(wheelbase,X_enter,X,V);              
value111 = 0;         % feet
value112 =@(wheelbase,X_enter,X,V)agony(wheelbase,X_enter,X,V);   
value113 = 0;         % feet
