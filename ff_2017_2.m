...
value105 = 0;         % seconds
value106 = 2;         % seconds
value107 = 15;        % miles per hour
value108 = 5;         % miles per hour
value109 = 10000;           
value110 =@(wheelbase,X_enter,X,V)cobblestone(wheelbase,X_enter,X,V);             
value111 = 1;         % feet
value112 =@(wheelbase,X_enter,X,V)cobblestone(wheelbase,X_enter,X,V);      
value113 = 1;         % feet
