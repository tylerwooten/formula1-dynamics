...
plot(T5,X5(:,1), 'c')
plot(T6,X6(:,1), 'm')
title('Displacement: Heave of 2017 Car on Cobblestone')
xlabel('time (sec)')
...
plot(T5,V5(:,1), 'c')
plot(T6,V6(:,1), 'm')
title('Velocity: Heave of 2017 Car on Cobblestone')
xlabel('time (sec)')
...
plot(T5,A5(:,1), 'c')
plot(T6,A6(:,1), 'm')
title('Acceleration: Heave of 2017 Car on Cobblestone')
xlabel('time (sec)')
...
title('Rotation: Pitch of 2017 Car on Cobblestone')
xlabel('time (sec)')
ylabel('Rotation (deg)')
...
title('Spin: Pitch of 2017 Car on Cobblestone')
xlabel('time (sec)')
ylabel('Spin (deg/sec)')
legend('1/2 Car 2 DOF', '1/2 Car 4 DOF', 'Full Car 3 DOF', 'Full Car 7 DOF')
hold off
...
title('Rate of Spin: Pitch of 2017 Car on Cobblestone')
xlabel('time (sec)')
...
title('Rotation: Roll of 2017 Car on Cobblestone')
xlabel('time (sec)')
ylabel('Rotation (deg)')
...
title('Spin: Roll of 2017 Car on Cobblestone')
xlabel('time (sec)')
ylabel('Spin (deg/sec)')
legend('Full Car 3 DOF', 'Full Car 7 DOF')
hold off
...
title('Rate of Spin: Roll of 2017 Car on Cobblestone')
xlabel('time (sec)')
ylabel('Rate of Spin (deg/sec^2)')
legend('Full Car 3 DOF', 'Full Car 7 DOF')
hold off
...
plot(T5,(AP(:,1)), 'r')
plot(T6,(X6(:,1)), 'b')
title('Heave of 2017 car Axle vs Chassis')
xlabel('time (sec)')
ylabel('Displacement (ft)')
legend('Chassis', 'Axle')
hold off
...
subplot(2,2,2); 
hold on 
plot(T5,(AP(:,2).*(180/pi)), 'r')%%% wrong %%%
plot(T6,(X6(:,2).*(180/pi)), 'b')
title('Pitch of 2017 car Axle vs Chassise')
xlabel('time (sec)')
ylabel('Rotation (deg)')
legend('Chassis', 'Axle')
hold off
...
title('Roll of 2017 car Axle vs Chassis')
xlabel('time (sec)')
ylabel('Rotation (deg)')
legend('Chassis', 'Axle')
hold off
